...
function change_footer_admin() {
  echo '<span id="footer-thankyou">Crafted <a href="http://domain.com/" target="_blank">Domain</a>.</span>';
}
...
add_action( 'admin_enqueue_scripts', function() {
  wp_enqueue_style('fontawesome', 'http://netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
}, 100);
