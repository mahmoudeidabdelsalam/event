...
class Blog extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(false, __('#Domain Blog', 'domain') , $widget_options);
    }

    function form($instance) {
        $defaults = array(
            'title' => __('Blog', 'domain'),
        );
    ...
    function widget($args, $instance) {
        ...
        <div class="blog-column" style="background-image:url('<?= $background_image; ?>'); background-color:<?= $background_color; ?>;">
          <div class="container pt-5 pb-5">
            ...
            <p class="elementor-text"><?php _e('Check our latest blog articles to learn the best use of powerpoint', 'domain'); ?></p>
               ...
               <?php 
                ...
                <div class="card wow bounceInUp">
                  ...
                  <div class="card-body">
                    ...
                    <p><a class="read-more" href="<?= $link; ?>"> <?php _e('Read More »', 'domain'); ?> </a></p>
