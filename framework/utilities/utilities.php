...
*
* @package    Utilities
* @author     Domain (Superheroes Team)
* @version    1.0.0
* @since      1.0.0 First time this was introduced.
* @copyright  All right reseved domain - 2017
...
class Utilities{
  ...
  */
  static function global_thumbnails($id, $size, $echo = true) {
    ...
    /**
    * Function Name: sage Shortcode - Utilities::sage_shortcode();
    * This Function can return the All of shortcodes in website
    * @param ()
    * @return (All in ShortCode array)
    */
    static function sage_shortcode() {
      $shortcodes = array(
        'sage ShortCode' => 'sage_shortcode',
      );
